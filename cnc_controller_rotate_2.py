...
def main():
    ...
    while True:
        command = input("Enter command (s=status, mh=move to machine home, h=go to work home, sethome=set work home, gp=get mechanical home position, a=absolute move, r=relative move, j=jog mode, q=quit): ").strip().lower()
